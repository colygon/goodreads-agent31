...
class BookAnalysisAgents:
    ...
    def reading_pattern_analyst(self) -> Agent:
        ...
        return Agent(
            ...
            actionable insights to help readers understand their habits better.""",
            llm=self.llm,
            verbose=True,
    ...
    def genre_diversity_specialist(self) -> Agent:
        ...
        return Agent(
            ...
            in reading lists and providing thoughtful, non-judgmental feedback.""",
            llm=self.llm,
            verbose=True,
            allow_delegation=False
        )
    ...
    def personalized_recommender(self) -> Agent:
        ...
        return Agent(
            ...
            diverse, and tailored to help readers discover their next favorite book.""",
            llm=self.llm,
            verbose=True,
            allow_delegation=False
        )
